...
export interface ApiFranquiciaFranquicia extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    lineas: Schema.Attribute.Relation<'manyToMany', 'api::linea.linea'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::franquicia.franquicia'
    > &
      Schema.Attribute.Private;
...
export interface ApiLineaLinea extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    franquicias: Schema.Attribute.Relation<
      'manyToMany',
      'api::franquicia.franquicia'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiMarcaMarca extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    lineas: Schema.Attribute.Relation<'oneToMany', 'api::linea.linea'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    franquicia: Schema.Attribute.Relation<
      'manyToOne',
      'api::franquicia.franquicia'
    >;
    Imagen: Schema.Attribute.Media<'images' | 'files', true>;
    linea: Schema.Attribute.Relation<'oneToOne', 'api::linea.linea'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
